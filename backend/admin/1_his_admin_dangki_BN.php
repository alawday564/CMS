                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="0_his_admin_tongquan.php">Dashboard</a></li>
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input required="required" type="text" name="pat_phone" class="form-control" id="inputCity" placeholder="">
                                                </div>
                                                <div class="form-group col-md-4">

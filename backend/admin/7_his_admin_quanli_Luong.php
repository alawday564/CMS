                                        ...
                                        <table id="demo-foo-filtering-x" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="7_his_admin_quanli_Luong.php?delete_pay_number=<?php echo $row->pay_number;?>" class="badge badge-danger"><i class="fas fa-trash"></i> Delete</a>
                                                        <a href="7_his_admin_capnhat_Luong.php?pay_number=<?php echo $row->pay_number;?>" class="badge badge-success"><i class="fas fa-edit "></i>Update Payroll</a>

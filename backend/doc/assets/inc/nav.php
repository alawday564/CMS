...
?>
    <div class="navbar-custom">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <div class="dropdown-header noti-title">
                        <h6 class="text-center m-0 ">Welcome !</h6>
                    </div>
                    <!-- item-->
                    ...
                    <!-- <a href="0_his_doc_update-account.php" class="dropdown-item notify-item">
                        <i class="fas fa-user-tag"></i>
                        <span>Cập Nhật Tài Khoản</span>
                    </a> -->
                    <!-- <div class="dropdown-divider"></div> -->
                    <!-- item-->
                    <a href="0_his_doc_logout.php" class="dropdown-item notify-item text-center">
        ...
        <!-- LOGO -->
        <div class="logo-box">
            <a href="0_his_doc_tongquan.php" class="logo text-center">
                <span class="logo-lg">
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    <!-- item-->
                    <a href="1_his_doc_dangki_BN.php" class="dropdown-item">
                        <i class="fe-activity mr-1"></i>
                        <span>Patient</span>
                    </a>
                    <!-- item-->
                    <a href="4_his_doc_them_baocao.php" class="dropdown-item">

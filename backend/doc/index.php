<?php
    ...
    if(isset($_POST['doc_login']))
    {
        ...
        $stmt=$connect->prepare("SELECT doc_number, doc_pwd, doc_id FROM his_docs WHERE  doc_number=? AND doc_pwd=? ");//sql to log in user
        ...
        if($rs)
            {//if its sucessfull
                header("location:0_his_doc_tongquan.php");
            }
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-success btn-block" name="doc_login" type="submit"> Sign In </button>
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p> <a href="0_his_doc_reset_pwd.php" class="text-white-50 ml-1">Forgot your password?</a></p>
